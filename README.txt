Note: Assume a MySQL server is running and configured through a 'config.yaml' file, based on 'config_sample.yaml'. Otherwise the history endpoint won't work. I have used MySQL Workbench/Server for testing on localhost;
